...
## Voice calibration (fill this in after 2–3 posts)

Paste 2 paragraphs you like that you wrote:
...
- More dry / more warm: 
- Shorter / longer: 
- OK to mention Crypto.com by name: yes / sparingly / no
- OK to mention metrics from resume: yes / only qualitative

## Solo mode without AI

Sunday: pick 2 ideas → draft → schedule  
Weekdays: 10 min comments  
Publish days: ship + reply  
Friday: capture inbox in idea-bank.md  
Update TRACKER.md
